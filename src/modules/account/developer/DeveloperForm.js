...
import { AppConstants, DATE_FORMAT_VALUE, DATE_FORMAT_ZERO_TIME, DEFAULT_FORMAT, TIME_FORMAT_DISPLAY, categoryKinds } from '@constants';
...
const DeveloperForm = (props) => {
    ...
    const handleSubmit = (values) => {
        ...
        values.birthday = values.birthday && dayjs(values?.birthday).format(DEFAULT_FORMAT);
                    ...
                    <Row gutter={16}>
                        ...
                        <Col span={12}>
                            <AutoCompleteField
                                ...
                                searchParams={(text) => ({ categoryName: text , kind: categoryKinds.CATEGORY_KIND_ROLE })}
                                required={isEditing ? false : true}
                            />
                        </Col>
                        <Col span={12}>
