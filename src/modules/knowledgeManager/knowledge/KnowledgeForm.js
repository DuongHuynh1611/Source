...
import { AppConstants, DATE_FORMAT_DISPLAY, DATE_FORMAT_VALUE, DATE_FORMAT_ZERO_TIME, DEFAULT_FORMAT, categoryKinds } from '@constants';
                ...
                <Row gutter={10}>
                    ...
                    <Col span={12}>
                        <AutoCompleteField
                            // disabled={dataDetail.state !== undefined && dataDetail.state !== 1}
                            required
                            label={<FormattedMessage defaultMessage="Danh mục kiến thức" />}
                            name="knowledgeId"
